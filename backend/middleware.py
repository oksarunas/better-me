...
from application_status import ApplicationStatus  # Moved to a dedicated module
...
async def request_middleware(request: Request, call_next: NextCallable) -> Response:
    """
