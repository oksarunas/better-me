...
/** Defines the progress container variants */
...
/** Defines the progress indicator variants */
...
export interface ProgressProps
  ...
  size?: "sm" | "md" | "lg" | "xl";
  glow?: boolean;
  indicatorVariant?: "default" | "success" | "warning" | "error" | "info" | "rainbow";
...
/** Progress bar component with customizable styles and behavior */
      ...
      <div className="w-full space-y-1">
        ...
        >
          <ProgressPrimitive.Indicator
            className={cn(
              indicatorVariants({ variant: dynamicVariant, animated }),
